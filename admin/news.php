...
{
	$insert = "INSERT INTO news values('0','$_REQUEST[tit]','".mysql_real_escape_string($_REQUEST['editor11'])."')";
	mysql_query($insert);	
 	...
 	<div class="asked">		    
			<form action="" method="post" enctype="multipart/form-data">
				<table>
					<tr>
						<td>Title : </td>
						<td><textarea style="border-radius:10px;" rows="5" cols="40" name="tit"></textarea>
						<!--<input type="text" name="tit"/>-->
						</td>
					</tr>
					 
				
						<textarea class="ckeditor" name="editor11"></textarea></div>
					<tr align="center">
				...
				<table >
                    <tr>
                        ...
                        <?php
						$o=mysql_query("select * from news");
					...
					?>
						<tr> 
							...
							<td><a href="del_news.php?id=<?php echo $d['id'];?>">DELETE</a></td>
							<td><a href="edit_news.php?idd=<?php echo $d['id'];?>">EDIT</a></td>
						</tr>
					<?php
						}
					?>
