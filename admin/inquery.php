			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<table >
                    <tr>
						...
						<?php
						$o=mysql_query("select * from inquery");
						while($d=mysql_fetch_array($o))
						{
					?>
						<tr>
							<td><img src="<?php echo $d['path'];?>" height="80px" width="120px"/></td>
							<td><?php echo $d['land_name'];?></td>
							<td><?php echo $d['land_price'];?></td>
							<td><?php echo $d['name'];?></td>
							<td><?php echo $d['emaill'];?></td>
							<td><?php echo $d['mono'];?></td>
							<td><?php echo $d['msg'];?></td>
							<td><a href="del_inquery.php?id=<?php echo $d['id'];?>">DELETE</a></td>
						</tr>
					<?php
						}
					?>
