			...
			<form action="" method="post" enctype="multipart/form-data">
                ...
                <table >
                    <tr>
						...
						<?php
							$o=mysql_query("select * from contact");
						...
						?>
							<tr>
								...
								<td><?php echo $d['subje'];?></td>
								<td><?php echo $d['mono'];?></td>
								<td><?php echo $d['msg'];?></td>
								<td><a href="del_contact.php?id=<?php echo $d['id'];?>">DELETE</a></td>
							</tr>
						<?php
							}
						?>
...
<!---->
<div class="copy">
            <p> &copy; 2016 Minimal. All Rights Reserved | Design by Preksh Mehta </p>
</div>
		</div>
		<div class="clearfix"> </div>
       </div>
