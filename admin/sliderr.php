...
if(isset($_REQUEST['save']))
{
	...
	{ 
		...
		$ex=".".$ext;
		$get=mysql_query("select max(id) from slider");
		...
		$c=dirname(__FILE__).'/slider/'.$ppname;
   
		$path='slider/'.$ppname;
		move_uploaded_file($_FILES['url']['tmp_name'],$c);
	} 
	$log=mysql_query("insert into slider values('0','$path')");
}
?>
<!--
Author: W3layouts
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<table >
                    <tr>
                        ...
                        <?php
						$o=mysql_query("select * from slider");
						while($d=mysql_fetch_array($o))
						{
					?>
						<tr>
							<td><img src="<?php echo $d['imag'];?>" height="80px" width="80px"/></td>
							<td><a href="del_slider.php?id=<?php echo $d['id'];?>">DELETE</a></td>
						</tr>
					<?php
						}
					?>
